...
[ ] CRUD for skills (name, category, level 1–5).

[ ] Skill cards/list with add/edit modals.
...
[ ] Log activity (hours/sessions per skill) interface.

[ ] Weekly progress charts (Recharts).

[ ] Current focus & recent activities timeline widgets.
