...
export const GraphView = ({ centerSkillId, nodes = [], links = [] }) => {
  ...
  return (
    <div
      ...
      className="relative w-full h-full bg-[#0a0e1a] flex items-center justify-center overflow-hidden rounded-xl border border-slate-800/50 shadow-inner"
    ...
    >
      ...
      <div
        ...
        className={`absolute left-6 flex gap-4 pointer-events-none z-10 ${isMobile ? "flex-col" : "flex-row"}`}
