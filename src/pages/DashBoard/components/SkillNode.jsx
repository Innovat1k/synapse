...
{/*MULTIPLE HANDLES: Allows curves to choose the smoothest path */}
      ...
      <div
        className={`
          w-28 h-20
          rounded-[45%_45%_40%_40%_/_55%_55%_45%_45%]
      ...
      >
        <div className="flex flex-col items-center px-3 pointer-events-none">
          <h3 className="text-[10px] font-extrabold uppercase tracking-tight text-center leading-tight mb-1.5 drop-shadow-sm">
            {label}
          </h3>
      ...
      {category && (
        <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 flex flex-col items-center opacity-40 group-hover:opacity-100 transition-all duration-500">
          <span className="text-[7px] font-black uppercase tracking-[0.3em] text-slate-500 group-hover:text-cyan-400">
            {category}
          </span>
        </div>
      )}
