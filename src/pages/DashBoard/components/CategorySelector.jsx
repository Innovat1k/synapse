  ...
  return (
    <div className="group relative min-w-35">
      ...
      <select
        ...
        className={`
          w-full bg-slate-900/40 hover:bg-slate-800/60 border border-slate-700/50 hover:border-cyan-500/30 rounded-lg 
          ${isSmall ? "pl-8 pr-7 py-1.5 text-xs" : "pl-9 pr-8 py-2 text-sm"}
          text-slate-100 font-medium appearance-none focus:outline-none focus:ring-2 focus:ring-cyan-400/40 focus:border-transparent transition-all cursor-pointer
        `}
      >
